...
#define DEFAULT_FEATURES (FEATURE_GPS | FEATURE_OPTICALFLOW | FEATURE_RANGEFINDER)
#define DEFAULT_OPTICALFLOW_HARDWARE OPTICALFLOW_MT
#define DEFAULT_RANGEFINDER_HARDWARE RANGEFINDER_MTF02P
